...
public class MonotonicStack {
    ...
    public int[] nextGreaterElement(int[] nums) {
        ...
        for (int i = 0; i < n; i++) {
            updateMonotonicStack(nums, result, stack, i, (index, value) -> nums[index]);
        }
        return result;
    }
    ...
    private void updateMonotonicStack(int[] values, int[] result, Stack<Integer> stack, int currentIndex, ResultUpdater updater) {
