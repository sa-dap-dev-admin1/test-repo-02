...
public class JiraController {
    ...
    public Message raiseJiraTicket(@RequestBody MultipartFile data) throws IOException {
        ...
        try {
            Optional<File> file = createFileFromCsvContents(csvContents, userToken);
    ...
    private Optional<File> createFileFromCsvContents(String csvContents, UserToken userToken) throws IOException {
        if (csvContents == null) {
