...
public class JiraController {
    ...
    public Message raiseJiraTicket(@RequestBody MultipartFile data) throws IOException {
        ...
        File file = processCSVContents(data, userToken);
    ...
    private File processCSVContents(MultipartFile data, UserToken userToken) throws IOException {
        String csvContents = fileHandler.extractCSVContents(data);
        return fileHandler.createFile(csvContents, userToken);
    }
    ...
    private Message createJiraTicket(File file) {
        try {
            ...
            throw new JiraTicketCreationException("Failed to create Jira ticket", e);
        }
    }
}