...
public class JiraController {
    ...
    public Message raiseJiraTicket(@RequestBody MultipartFile data) throws IOException {
        ...
        try {
            ...
            File csvFile = createCSVFile(tempDir, csvContents, userToken);
            return processJiraTicket(csvFile);
        } catch (IOException e) {
    ...
    private File createCSVFile(File dir, String csvContents, UserToken userToken) throws IOException {
        // doing null check 
        if (csvContents == null) {
        ...
        writeFileContents(file, csvContents);
        return file;
    }

    private void writeFileContents(File file, String content) throws IOException {
