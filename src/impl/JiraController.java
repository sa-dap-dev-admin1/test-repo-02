...
public class JiraController {
    ...
    public Message raiseJiraTicket(@RequestBody MultipartFile data) throws IOException {
        ...
        String userId = jiraFileHandler.getCurrentUserId();
        String filePath = jiraFileHandler.saveFile(csvContents, userId);
        return jiraTicketService.createJiraTicket(filePath);
    }
}