...
public class JiraController {
    ...
    public Message raiseJiraTicket(@RequestBody MultipartFile data) throws IOException {
        ...
        String csvContents = fileHandler.getFileContents(data);
        return processJiraTicket(userId, csvContents);
    }

    private Message processJiraTicket(String userId, String csvContents) throws IOException {
        if (csvContents == null) {
            throw new IllegalArgumentException("CSV contents cannot be null");
        }
        
        java.io.File file = fileHandler.createTempFile(userId, csvContents);
