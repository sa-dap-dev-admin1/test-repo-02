...
public class JiraController {
    ...
    public Message raiseJiraTicket(@RequestBody MultipartFile data) throws IOException {
        ...
        File file = handleFileCreation(csvContents, userToken);
        return createJiraTicket(file);
    }

    private File handleFileCreation(String csvContents, UserToken userToken) throws IOException {
        if (csvContents == null) {
            return null;
        }
    ...
    // This method seems unrelated to the JiraController functionality.
