...
public class JiraController {
    ...
    @Autowired
    private JiraSecurityUtils securityUtils;
    ...
    public Message raiseJiraTicket(@RequestBody MultipartFile data) throws IOException {
        try {
            ...
            String csvContents = validateAndExtractCSV(data);
            File file = fileHandler.createTemporaryFile(csvContents, userToken.getUserId());
    ...
    private String validateAndExtractCSV(MultipartFile data) throws IOException {
        if (data == null || data.isEmpty()) {
            throw new IllegalArgumentException("CSV data is required");
        }
